...
if(isset($_REQUEST['psubmit'])){
 ...
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['tableno'] == "") || ($_REQUEST['psellingcost'] == "")){
  ...
  $psellingcost = $_REQUEST['psellingcost'];
   $sql = "INSERT INTO `assets_tb`( `pname`, `pdop`, `pava`, `ptotal`, `tableno`, `psellingcost`) VALUES ('$pname', '$pdop', ' $pava', '$ptotal' , '$tableN', '$psellingcost' )";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="poriginalcost">Table No</label>
